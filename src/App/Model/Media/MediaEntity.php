...
class MediaEntity extends AbstractEntity implements MediaEntityInterface
{
    ...
    public function getArrayCopy(): array
    {
        ...
        $this->getExchangeValue($data, 'media_box');
    ...
    public function exchangeArray(array $data): static
    {
        ...
        $this->setExchangeValue($data, 'media_box');
    ...
    public function getMediaBox(): ?int
    {
        return $this->media_box;
    }

    public function setMediaBox(?int $value)
    {
        $this->media_box = $value;
    }
