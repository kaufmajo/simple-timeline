...
class MngMediaWritePage extends AbstractBasePage
{
    ...
    public const LAST_URL_NAMESPACE = "mng-media";
    ...
    public function insertAction(ServerRequestInterface $request): HtmlResponse|RedirectResponse
    {
        ...
        $viewData = [
            ...
            'redirectUrl'  => $this->getUrlpoolService()->keep()->getUrl(),
        ...
        $this->flashMessages()->flash('info', 'default');

        return new RedirectResponse($this->getUrlpoolService()->getUrlWithAnchor($mediaEntity->getMediaId()));
    }
    ...
    public function updateAction(ServerRequestInterface $request): HtmlResponse|RedirectResponse
    {
        ...
        $viewData = [
            ...
            'mediaForm'    => $mediaForm,
            'mediaEntity'  => $mediaEntity,
            'redirectUrl'  => $this->getUrlpoolService()->keep()->getUrlWithAnchor($mediaEntity->getMediaId()),
            'datalist'     => ['tag' => $tagData],
        ];
