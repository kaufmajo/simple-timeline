...
return function (Application $app, MiddlewareFactory $factory, ContainerInterface $container): void {
    ...
    $app->get('/', [
        App\Middleware\ServerCacheMiddleware::class,
        App\Handler\Termin\DefTerminIndexHandler::class,
    ], 'default.root');
    ...
    $app->route('/howto', [
        App\Middleware\ServerCacheMiddleware::class,
        App\Handler\Termin\DefTerminHowtoHandler::class,
    ], ['GET'], 'default.termin.howto');
    ...
    $app->route('/manage/termin-read[/{action:index}]', [
        App\Page\Termin\MngTerminReadPage::class,
    ], ['GET'], 'manage.termin.read');

    $app->route('/manage/termin-write[/{action:insert|update|delete|copy|plus}[/{date}]]', [
